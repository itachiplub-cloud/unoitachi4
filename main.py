...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    help_text = (
        ...
        "/uploadcard — Upload a new card\n"
        "/editcard — Edit a card\n"
        "/gift — Gift a card to someone\n"
        "/sellcard — Sell a card\n"
        "/exchange — Exchange cards\n"
        "/allcards — View all cards (admin)\n"
        "</blockquote>"
        ...
        "/mintasset — Mint a new asset\n"
        "/removeasset — Remove an asset\n"
        "/auditvault — Audit vault\n"
        "/assetshare — Share asset\n"
        "/flashsale — Flash sale event\n"
        "/fluctuateprices — Fluctuate prices\n"
        "/runbankengine — Run bank engine\n"
        "</blockquote>"
        ...
        "/flystorm — Fly storm mode\n"
        "/flyshd — Fly shield\n"
        "/mines &lt;bombs&gt; &lt;coins&gt; — Dodge bombs, win coins\n"
        "/minestrap — Toggle mine strap\n"
        ...
        "/guessbet &lt;amount&gt; — Guess and bet\n"
        "/spin — Spin the wheel\n"
        "/enter — Enter event\n"
        "/heist — Heist challenge\n"
        "</blockquote>"

        "\n🏍️ <b>Vehicles &amp; Showroom</b>"
        "\n<blockquote>"
        "/showroom — View all vehicles\n"
        "/myshowroom — View your vehicles\n"
        "/buy &lt;id&gt; — Buy a vehicle\n"
        "/sellitem — Sell a vehicle\n"
        "/market — View market listings\n"
        "/buymitem — Buy from market\n"
        "/mylistings — View your listings\n"
        "/cancelitem — Cancel a listing\n"
        "/additem — Add item to showroom\n"
        "</blockquote>"
        ...
        "/topbank — Top bank accounts\n"
        "/createbank — Create a bank\n"
        "/joinbank — Join a bank\n"
        "/leavebank — Leave your bank\n"
        "/confirmleavebank — Confirm leaving\n"
        "/bankinfo — Bank info\n"
        "/bankdeposit — Bank deposit\n"
        "/bankwithdraw — Bank withdraw\n"
        "/bankrank — Bank ranking\n"
        "/bankdashboard — Bank dashboard\n"
        "/transferbank — Transfer in bank\n"
        "/bankmembers — Bank members\n"
        "/deletebank — Delete bank\n"
        "/banklog — Bank logs\n"
        "/bankinvite — Invite to bank\n"
        "/bankaudit — Audit bank\n"
        "/claiminterest — Claim interest\n"
        "/taxbank — Tax bank\n"
        "/taxtop — Tax leaderboard\n"
        "/banklist — List banks\n"
        "</blockquote>"
        ...
        "\n🎁 <b>Giveaways</b>"
        "\n<blockquote>"
        "/giveawaycards — View giveaway cards\n"
        "/uploadgiveawaycard — Upload giveaway card\n"
        "/editgiveawaycardbyindex — Edit giveaway card\n"
        "/givecard — Give a card\n"
        "/mygiveaways — My giveaways\n"
        "/giveawaylist — List giveaways\n"
        "/removegivecard — Remove giveaway card\n"
        "/deletegiveawaycard — Delete giveaway card\n"
        "</blockquote>"
        ...
        "\n🗣️ <b>Word Game</b>"
        "\n<blockquote>"
        "/startwordgame — Start word game\n"
        "/ithink or /g — Guess a word\n"
        "/hint — Get a hint\n"
        "/wordscore — View word score\n"
        "/wordtop — Word leaderboard\n"
        "</blockquote>"

        "\n🎭 <b>Truth &amp; Dare</b>"
        "\n<blockquote>"
        "/tnd — Start truth or dare\n"
        "/jointnd — Join a game\n"
        "/ready — Ready up\n"
        "/truth — Pick truth\n"
        "/dare — Pick dare\n"
        "/complete — Complete a dare\n"
        "/leavetnd — Leave game\n"
        "/endtnd — End game\n"
        "/toptnd — Top players\n"
        "/tndstats — Your stats\n"
        ...
        "/rakhi — Rakhi menu\n"
        "/rakhibond — Bond rakhi\n"
        "/rakhiuntie — Untie rakhi\n"
        "/rakhiwrite — Write wish\n"
        "/rakhiwall — Wish wall\n"
        "/rakhiarchive — Archive\n"
        "/rakhitop — Top rakhi\n"
        "/party — Start a party\n"
        ...
        "/referrank — Referral ranking\n"
        "/setrefreward — Set referral reward\n"
        "</blockquote>"

        "\n🔮 <b>Shinobi System</b>"
        "\n<blockquote>"
        "/shinobishop — Shinobi shop\n"
        "/byitem — Buy shop item\n"
        "/shinobiquiz — Shinobi quiz\n"
        "/shinobichest — View chest\n"
        "/shinobiarena — Arena battle\n"
        "/shinobitask — Daily tasks\n"
        "/shinobiblessing — Blessings\n"
        "/shinobiforge — Forge items\n"
        "/shinobitrade — Trade items\n"
        "/shinobialtar — Altar\n"
        "/shinobimarket — Market\n"
        "/shinobitomb — Tomb raid\n"
        "/tombstats — Tomb stats\n"
        "/shinobifusion — Fusion\n"
        "/shinobibattle — Battle\n"
        "/shinobirelic — Relics\n"
        "/shinobiartefact — Artefacts\n"
        "/shinobiblessingvault — Blessing vault\n"
        "</blockquote>"
        ...
        "/myclan — View your clan\n"
        "/clanrank — Clan ranking\n"
        "/clangoal — Clan goal\n"
        "/settitle — Set clan title\n"
        "</blockquote>"

        "\n💬 <b>Group Management</b>"
        "\n<blockquote>"
        "/welcome — View welcome msg\n"
        "/farewell — View farewell msg\n"
        "/setwelcome — Set welcome msg\n"
        "/setfarewell — Set farewell msg\n"
        "/viewwelcome — View welcome config\n"
        "/schedulemsg — Schedule a message\n"
        "/viewschedule — View scheduled msgs\n"
        "/clearschedule — Clear scheduled msgs\n"
        "/mentionall — Mention all members\n"
        "/groupstats — Group statistics\n"
        "/sab — SAB menu\n"
        "/circle_list — Circle list\n"
        "/circle_clear — Clear circle\n"
        "/sahab — Sahab menu\n"
        "</blockquote>"

        "\n☁️ <b>Cloud Storage</b>"
        "\n<blockquote>"
        "/cloudstart — Cloud dashboard\n"
        "/cloudregister — Create cloud account\n"
        "/cloudlogin — Login to cloud\n"
        "/cloudlogout — Logout from cloud\n"
        "/cloudsaved — View saved files\n"
        "/cloudsearch &lt;query&gt; — Search files\n"
        "/cloudget &lt;index&gt; — Get a file\n"
        "/clouddelete &lt;index&gt; — Delete a file\n"
        "/cloudstorage — Storage usage\n"
        "/cloudgenlink &lt;index&gt; — Generate share link\n"
        "/cloudmylinks — View share links\n"
        "/cloudrevokelink &lt;token&gt; — Revoke share link\n"
        "</blockquote>"
